...
with st.form("contact_form"):
    ...
    if submitted:
        # Initialize feedback service once
        feedback_service = FeedbackService(st.secrets)
        # Save feedback (Firestore first, CSV fallback)
        feedback_service.save(name, email, message)
